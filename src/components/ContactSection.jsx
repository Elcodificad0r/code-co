      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:!grid-cols-2 gap-12 lg:!gap-16 items-center lg:!items-start justify-items-center lg:!justify-items-start text-center lg:!text-left">
          ...
          <div className="space-y-8 w-full max-w-lg lg:!max-w-none">
            <div ref={titleRef} className="space-y-4">
              <h1 className="font-rubik80s text-5xl md:text-7xl lg:!text-8xl font-black text-gray-900 leading-none">
                Hablemos
                <span className="block text-blue-600 mt-2">de tu</span>
                <span className="block text-gray-900 mt-2">proyecto*</span>
              </h1>
        ...
        <footer className="mt-12 w-full bg-white/10 backdrop-blur-sm rounded-xl py-6 px-4 md:px-8 text-black font-space">
          <div className="flex flex-col md:!flex-row md:!justify-between md:!items-center space-y-2 md:!space-y-0">
            <span>Code&Co. Monterrey N.L.</span>
            <span>権利が留保されています / 2024年以降</span>
            <span>we build, we create, we code.</span>
          </div>
        </footer>
      </div>
    </section>
