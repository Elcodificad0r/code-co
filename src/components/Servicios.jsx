...
export default function ServicesHero() {
  ...
  useEffect(() => {
    ...
    const mainScrubStart = isMobile ? "top 85%" : "top 60%";
    const mainScrubEnd = isMobile ? "bottom 20%" : "bottom 20%";
  ...
  return (
    <section
      ref={containerRef}
      className="relative bg-[#ECECEC] min-h-screen overflow-hidden py-16"
      style={{ backgroundColor: bg }}
    >
      <div
        ref={topSectionRef}
        className="flex flex-row flex-wrap justify-between items-end px-8 md:px-16 mb-20"
      >
        <div className="animate-section flex-shrink-0">
          <div
            ref={weekRef}
            className="text-gray-600 text-lg tracking-wider"
            style={{ color: textMuted }}
          >
            <div className="font-bold">WE</div>
            <div className="font-bold">EK</div>
            <div className="font-light text-xl mt-1 font-mono">
              {currentWeek}
            </div>
          </div>
        </div>
        ...
        <div className="animate-section flex-shrink-0 mx-8">
          ...
          <div
            ref={servicesTextRef}
            className="space-y-3 text-gray-700 max-w-xs text-xl"
            style={{ color: textMuted }}
          >
            <div className="service-item font-space">
              <strong style={{ color: textStrong }}>Landing Page →</strong>{" "}
              Sitios rápidos y efectivos.
            </div>
            <div className="service-item font-regular">
              <strong style={{ color: textStrong }}>Sitio web.2* →</strong> Ideal
              para consultorios, marcas y empresas.
            </div>
            <div className="service-item font-regular">
              <strong style={{ color: textStrong }}>SEO* →</strong> Significa
              visibilidad: más clics, más clientes.
            </div>
            <div className="service-item font-regular">
              <strong style={{ color: textStrong }}>Diseño→</strong>{" "}
      ...
      <div className="flex justify-center items-center px-8 md:px-16">
        <div ref={mainTextRef} className="text-center">
          <div className="text-8xl md:text-9xl lg:text-[24rem] leading-none tracking-tight">
            <span
              className="font-bold font-space text-black"
            ...
            <br />
            <span
              className="font-rubik80s text-8xl md:text-9xl lg:text-[12rem]"
              style={{ color: textStrong }}
            >
              WEB
            </span>
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none -z-10">
        <div
          className="text-gray-200 text-[400px] md:text-[600px] lg:text-[800px] leading-none opacity-10 animate-pulse"
