...
const Faq = () => {
  ...
  const textPrimary   = dark ? "#F2F0E4"           : "#111827"; // gray-900
  const textMuted     = dark ? "#a0a8b8"           : "#4B5563"; // gray-600
  const textAnswer    = dark ? "#c8cfd8"           : "#1F2937"; // gray-800
  ...
  const cardBorder    = dark ? "#3b5bdb"           : "#1e40af"; // blue-800 equivalent
  const cardBorderIdle= dark ? "#444444"           : "#e5e7eb"; // gray-200
  ...
  const faqData = [
    {
      ...
      answer:
        "Sí. Todas nuestras páginas incluyen estructura optimizada para SEO básico, velocidad optimizada y buenas prácticas técnicas para posicionamiento.",
      pos: { x: "15%", y: "20%" },
      rotation: -8,
      size: "medium",
    },
    ...
    },
    {
      ...
      answer:
        "Sí, incluimos 2 rondas de revisiones menores sin costo. Y el mantenimiento mensual inicia desde 500 MXN.",
      pos: { x: "85%", y: "55%" },
      rotation: 15,
      size: "medium",
    },
    {
      ...
      answer:
        "Por supuesto. Integramos pasarelas de pago como Stripe, PayPal o sistemas locales según tu necesidad.",
      pos: { x: "68%", y: "72%" },
      rotation: -12,
      size: "large",
    },
    {
      ...
      answer:
        "Trabajamos con proyectos de cualquier escala, desde startups hasta corporativos. Cada proyecto recibe la misma dedicación.",
      pos: { x: "10%", y: "70%" },
      rotation: 6,
      size: "medium",
    },
    {
      ...
      answer:
        "Incluimos hasta 3 iteraciones de diseño. Trabajamos contigo hasta que el resultado sea exactamente lo que necesitas.",
      pos: { x: "32%", y: "90%" },
      rotation: -18,
      size: "small",
    },
  ...
  const MobileView = () => (
    <div className="mobile-faq w-full overflow-x-hidden">
      <style>{`
        .faq-mobile-item {
          border-top: 1.5px solid ${borderMuted};
        }
        .faq-mobile-item:last-child {
          border-bottom: 1.5px solid ${borderMuted};
        }
        .faq-mobile-bar {
          display: block;
          height: 2px;
        ...
        .faq-mobile-num {
          ...
          line-height: 1;
          color: transparent;
          -webkit-text-stroke: 1.5px ${numStroke};
      ...
      {faqData.map((item, index) => {
        ...
        return (
          <div key={item.id} className="faq-mobile-item" style={item.id === 5 || item.id === 7 ? { paddingTop: "0.75rem" } : {}}>
            {/* Barra azul animada al top del item */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="faq-title-wrap mb-16 text-center">
          ...
          <p className="font-space text-lg md:text-xl max-w-2xl mx-auto" style={{ color: textMuted }}>
            *O no tan frecuentes, pero importantes para ti
          </p>
        </div>
