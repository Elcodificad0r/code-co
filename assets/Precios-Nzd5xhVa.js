import{r as o,j as e}from"./react-vendor-Cnp1Yea5.js";import{g as n,S as P}from"./gsap-FdPegQMx.js";import"./vendor-qoGMWrsY.js";import"./spline-BMX4pKPO.js";n.registerPlugin(P);function R(){const[s,p]=o.useState(()=>document.documentElement.classList.contains("dark"));return o.useEffect(()=>{const g=new MutationObserver(()=>p(document.documentElement.classList.contains("dark")));return g.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>g.disconnect()},[]),s}function G(){const s=o.useRef(null),p=o.useRef([]),[g,f]=o.useState(-1),[b,h]=o.useState(!1),i=R(),C=i?"#1E1E1E":void 0,N=i?"#2a2a2a":"#ffffff",L=i?"#444444":"#000000",a=i?"#F2F0E4":"#000000",d=i?"#a0a8b8":void 0,w=i?"#F2F0E4":"#000000",y=i?"#1E1E1E":"#ffffff",v=i?"#F2F0E4":"#000000",S=i?"#2a2a2a":"#ffffff",z=i?"#444444":"#000000",[x,m]=o.useState("full"),E="min(calc(100vh - 220px), 640px)",I="min(62svh, 480px)",[k,M]=o.useState(E);o.useEffect(()=>{var c;const t=()=>{const l=window.matchMedia("(max-width: 767px)").matches;M(l?I:E)};t();const r=window.matchMedia("(max-width: 767px)");return(c=r.addEventListener)==null||c.call(r,"change",t),()=>{var l;return(l=r.removeEventListener)==null?void 0:l.call(r,"change",t)}},[]),o.useEffect(()=>{const t=()=>{const r=window.innerHeight;r>=700?m("full"):r>=580?m("noDesc"):r>=460?m("noFeatures"):m("noLetter")};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]);const j=x==="full",D=x==="full"||x==="noDesc",O=o.useMemo(()=>[{letter:"C",title:`SITIO WEB.2
...
PERSONALIZADA`,description:"Desarrollo a medida para proyectos avanzados.",features:["✓ Incluye todo lo anterior","✓ Funcionalidades a medida","✓ Integraciones API","✓ SEO técnico avanzado","✓ Escalabilidad empresarial"],price:"¡PLATIQUEMOS!"}],[]);o.useEffect(()=>{const t=n.context(()=>{n.set(".pricing-card",{opacity:0,y:100,scale:.9}),n.set(".pricing-letter",{rotation:-10,opacity:.5}),n.to(".pricing-card",{opacity:1,y:0,scale:1,duration:1.2,stagger:.15,ease:"power3.out",scrollTrigger:{trigger:s.current,start:"top 80%",once:!0}}),n.to(".pricing-letter",{rotation:0,opacity:1,duration:1.5,stagger:.1,ease:"elastic.out(1, 0.5)",delay:.3,scrollTrigger:{trigger:s.current,start:"top 80%",once:!0}})},s);return()=>t.revert()},[]);const F=t=>{f(t);const r=p.current[t];r&&n.to(r,{scale:1.02,duration:.45,ease:"power3.out"})},A=()=>{f(-1),p.current.forEach(t=>{t&&n.to(t,{scale:1,duration:.45,ease:"power3.out"})})},B=t=>{const r=encodeURIComponent(`Cotización: ${t.replace(/\n/g," ")}`),c=encodeURIComponent(`Hola, me gustaría recibir una cotización para el plan: ${t.replace(/\n/g," ")}

`);window.location.href=`mailto:hola@codenco.com?subject=${r}&body=${c}`},T=()=>{navigator.clipboard.writeText("hola@codenco.com"),h(!0),setTimeout(()=>h(!1),2e3)};return e.jsxs("section",{ref:s,className:"bg-[#ECECEC] py-16 px-8 sm:px-16",style:{backgroundColor:C},children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("div",{className:"pricing-row flex flex-col gap-4 justify-center items-stretch max-w-7xl mx-auto mb-12",children:O.map((t,r)=>{const c=t.price.includes("6,999"),l=u=>p.current[r]=u;return e.jsxs("div",{ref:l,className:"pricing-card bg-white border-2 border-black px-7 py-6 md:px-6 md:py-5 flex-1 flex flex-col transform-gpu w-full md:w-1/4 hover:cursor-pointer relative will-change-transform",style:{height:k,minHeight:k,backgroundColor:N,borderColor:L},onMouseEnter:()=>F(r),onMouseLeave:A,children:[c&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"premium-glow"}),e.jsx("div",{className:"premium-border-overlay"}),e.jsx("div",{className:"absolute top-3 left-1/2 -translate-x-1/2 z-[20] bg-white border border-black px-3 py-1",style:{backgroundColor:S,borderColor:z},children:e.jsx("span",{className:"pricing-badge-label text-[10px] tracking-[0.35em] uppercase font-space text-black block text-center",style:{color:a},children:"MÁS VENDIDO"})})]}),j&&e.jsx("div",{className:"pricing-inner-top mt-9 md:mt-12 flex justify-center",children:e.jsx("div",{className:"pricing-letter text-[150px] md:text-[150px] lg:text-[130px] xl:text-[120px] font-rubik80s text-black leading-none text-center",style:{color:a},children:t.letter})}),e.jsxs("div",{className:"pricing-content-gap mt-6 md:mt-15 lg:mt-12 flex-1 flex flex-col sm:px-8 lg:px-8 min-h-0",children:[e.jsx("div",{className:j?"mb-9":"mb-4",children:e.jsx("h3",{className:"pricing-title text-xl sm:text-2xl md:text-[20px] lg:text-[18px] font-bold font-space leading-tight mt-1 whitespace-pre-line text-black",style:{color:a},children:t.title})}),e.jsx("p",{className:"pricing-desc text-sm font-space mb-4 md:mb-3 text-gray-700",style:{color:d},children:t.description}),D&&e.jsx("div",{className:"flex-grow mb-4 min-h-0 pricing-features-scroll",children:e.jsx("ul",{className:"space-y-2 pricing-feat text-sm font-space",children:t.features.map((u,H)=>e.jsx("li",{className:"text-gray-700",style:{color:d},children:u},H))})})]}),e.jsxs("div",{className:"mt-auto",children:[e.jsx("div",{className:"pricing-desde text-xs font-space text-gray-500 mb-2",style:{color:d},children:"DESDE"}),e.jsx("div",{className:"pricing-price text-2xl sm:text-3xl font-bold font-space text-black mb-4",style:{color:a},children:t.price}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("button",{className:"pricing-btn flex-1 bg-black text-white py-3 px-4 font-bold font-space text-sm tracking-wider hover:bg-gray-800 transition-all duration-300 border-2 border-black hover:scale-105 transform flex items-center justify-center gap-2",style:{backgroundColor:w,color:y,borderColor:v},onClick:()=>B(t.title),title:"Enviar correo",children:[e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{width:"20",height:"16",x:"2",y:"4",rx:"2"}),e.jsx("path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"})]}),"COTIZAR"]}),e.jsx("button",{className:"pricing-btn bg-black text-white py-3 px-4 font-bold font-space text-sm hover:bg-gray-800 transition-all duration-300 border-2 border-black hover:scale-105 transform flex items-center justify-center",style:{backgroundColor:w,color:y,borderColor:v},onClick:T,title:b?"¡Copiado!":"Copiar email",children:b?e.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("polyline",{points:"20 6 9 17 4 12"})}):e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2"}),e.jsx("path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"})]})})]})]})]},r)})}),e.jsxs("div",{className:"max-w-5xl md:ml-auto md:mr-12 md:text-right mb-5",children:[e.jsx("h4",{className:"text-xl font-bold font-space text-black mb-2",style:{color:a},children:"Condiciones adicionales*"}),e.jsxs("p",{className:"text-sm font-space text-gray-700 leading-relaxed",style:{color:d},children:["La ronda de cambios incluye ajustes menores posteriores a la entrega. El mantenimiento mensual inicia desde $500 MXN, dependiendo del tipo de proyecto y funcionalidades implementadas. Para más detalles consulta nuestros"," ",e.jsx("a",{href:"#terminos",className:"underline hover:opacity-70 transition",style:{color:a},children:"términos y condiciones"}),"."]}),e.jsxs("div",{className:"pricing-cta-row mt-5 flex flex-col sm:flex-row items-start sm:items-center sm:justify-end gap-3",children:[e.jsxs("p",{className:"text-sm font-space",style:{color:d??"#374151"},children:["¿No tenemos un plan para ti? Escríbenos a"," ",e.jsx("span",{className:"font-bold",style:{color:a},children:"hola@codenco.mx"})," ","y lleguemos a un acuerdo."]}),e.jsx("a",{href:"mailto:hola@codenco.mx",className:"shrink-0 inline-flex items-center gap-2 px-5 py-2.5 font-bold font-space text-sm text-white tracking-wide transition-all duration-300 hover:scale-105",style:{backgroundColor:"#0520F5",borderRadius:"9999px",boxShadow:"0 0 18px rgba(5,32,245,0.55), 0 0 40px rgba(5,32,245,0.25)"},onMouseEnter:t=>{t.currentTarget.style.boxShadow="0 0 28px rgba(5,32,245,0.85), 0 0 60px rgba(5,32,245,0.4)"},onMouseLeave:t=>{t.currentTarget.style.boxShadow="0 0 18px rgba(5,32,245,0.55), 0 0 40px rgba(5,32,245,0.25)"},children:"Escríbenos 🫱🏻‍🫲🏼"})]})]})]})}export{G as default};
