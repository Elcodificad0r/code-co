const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/react-vendor-rgf-A-eq.js","assets/vendor-DIA31StL.js","assets/spline-ybgFhZPv.js"])))=>i.map(i=>d[i]);
import{_ as C}from"./spline-ybgFhZPv.js";import{r as n,j as e,d as S,R as E}from"./react-vendor-rgf-A-eq.js";import"./vendor-DIA31StL.js";const T=E.lazy(()=>C(()=>import("./react-vendor-rgf-A-eq.js").then(t=>t.e),__vite__mapDeps([0,1,2])));function L(){const[t,a]=n.useState(()=>document.documentElement.classList.contains("dark"));return n.useEffect(()=>{const s=new MutationObserver(()=>a(document.documentElement.classList.contains("dark")));return s.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>s.disconnect()},[]),t}const I=`
