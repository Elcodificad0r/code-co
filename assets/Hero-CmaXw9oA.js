...
import{_ as C}from"./spline-BMX4pKPO.js";import{r as n,j as e,d as S,R as E}from"./react-vendor-Cnp1Yea5.js";import"./vendor-qoGMWrsY.js";const L=E.lazy(()=>C(()=>import("./react-vendor-Cnp1Yea5.js").then(t=>t.e),__vite__mapDeps([0,1,2])));function T(){const[t,a]=n.useState(()=>document.documentElement.classList.contains("dark"));return n.useEffect(()=>{const s=new MutationObserver(()=>a(document.documentElement.classList.contains("dark")));return s.observe(document.documentElement,{attributes:!0,attributeFilter:["class"]}),()=>s.disconnect()},[]),t}const I=`
